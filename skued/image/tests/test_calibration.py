...
def test_detector_scattvectors_default_center():
    ...
    qx, qy, qz = detector_scattvectors(keV=200, camera_length=1, shape=(512, 512), pixel_size=1e-6, center=None)
...
def test_detector_scattvectors_ewald_radius():
    ...
    Ewald sphere radius"""
    qx, qy, qz = detector_scattvectors(keV=200, camera_length=1, shape=(128, 128), pixel_size=1e-6, center=None)
