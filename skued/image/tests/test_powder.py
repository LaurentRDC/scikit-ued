...
import numpy as np
from .. import azimuthal_average, powder_center, calibrate_scattvector
...
class TestCalibrateAngle(unittest.TestCase):
    ...
    def test_simulation(self):
        ...
        calibrated = calibrate_scattvector(I, c, peak_indices = (arr_index1, arr_index2), miller_indices = (peak1, peak2))
